...
function TemplateFrames({ type, url }) {
    return (
        <div className="relative w-full h-[245px] bg-gray-200 rounded-lg cursor-pointer overflow-hidden group">
            { type && 
            ...
            <div className="absolute top-0 bottom-0 left-0 w-[10%] p-2 opacity-0 group-hover:opacity-100 transition-all duration-200">
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-l from-black/0 to-black/50"></div>
            </div>

            <div className="absolute top-0 bottom-0 right-0 w-[10%] p-2 opacity-0 group-hover:opacity-100 transition-all duration-200">
                <div class="absolute top-0 right-0 w-full h-full bg-gradient-to-r from-black/0 to-black/50"></div>
