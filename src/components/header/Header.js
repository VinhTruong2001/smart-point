...
function Header() {
    ...
    return (
        <div ref={ headerRef } className={`fixed top-0 right-0 left-0 z-20 h-16 px-3 lg:px-4 flex items-center justify-between bg-gradient-to-r from-[#fe3847] to-[#171c44]`}> 
            <Link to="/">
